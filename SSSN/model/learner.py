...
class ASSNLearner(nn.Module):
    def __init__(self, cfg, inch):
        super(ASSNLearner, self).__init__()
    ...
    def forward(self, hypercorr_pyramid, query_feats, support_mask, corr_transformer):
        return self.ours(hypercorr_pyramid, query_feats, support_mask, corr_transformer)
